...
export default function CardContainer({ variant, children, className }: Props) {
  const baseLayout = {
    grid: 'flex flex-col justify-between w-full h-60.5 sm:h-105.75 lg:h-91.5 shadow-[0_0_20px_rgba(0,0,0,0.08)] rounded-3xl overflow-hidden',
    ...
    reservation:
      'flex w-full flex-col lg:flex-row rounded-3xl bg-white shadow-[0_10px_24px_-12px_rgba(156,180,202,0.20)]',
  }[variant];
